...
def main() -> None:
    ...
    for cancer in cancers:
        summary_path = root / f"{cancer}_xgboost3000_seed44" / "summary.csv"
    ...
    ax.set_title("Single-Cancer Top3000 z-score, Mean-Pooled XGBoost", fontsize=17, weight="bold")
    ax.grid(axis="y", linestyle="--", alpha=0.25)
    ax.set_ylim(0, out_df["Test"].max() * 1.18)
    fig.tight_layout()
    fig.savefig(root / "three_cancer_shareddata_top3000_xgboost.png", dpi=220)
