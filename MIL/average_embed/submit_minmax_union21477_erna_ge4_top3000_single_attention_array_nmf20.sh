...
#SBATCH --array=0-2
#SBATCH --output=/taiga/illinois/vetmed/cb/kwang222/enhancer/MIL/average_embed/minmax_union21477_erna_ge4_top3000_fixedsplit/logs/single_nmf20_%A_%a.out
#SBATCH --error=/taiga/illinois/vetmed/cb/kwang222/enhancer/MIL/average_embed/minmax_union21477_erna_ge4_top3000_fixedsplit/logs/single_nmf20_%A_%a.err
...
"${PY}" "${ROOT}/MIL/average_embed/run_skcm_top1000_attention_regression.py" \
  ...
  --out-dir "${RUN_ROOT}/single_attention_k300_mixup_nmf20/${CANCER}" \
  --epochs 50 \
  --batch-size 8 \
  --num-workers 4 \
